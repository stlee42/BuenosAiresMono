...
* [FontForge](https://fontforge.org/) with both Python and classic scripting
  feature enabled
* [fontmake](https://github.com/googlefonts/fontmake) (automatically installs [fontTools](https://github.com/fonttools/fonttools) and [ttfautohint-py](https://github.com/fonttools/ttfautohint-py) as dependencies.)
